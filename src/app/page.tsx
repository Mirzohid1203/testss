    ...
    <div className="relative flex flex-col items-center justify-center overflow-hidden px-4 py-24 text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          {user ? (
            ...
            <>
              ...
              <Link
                href="/login"
                className="flex w-full items-center justify-center gap-2 rounded-xl border border-gray-700 bg-gray-900 px-8 py-4 text-lg font-semibold text-white transition-all hover:bg-gray-800 sm:w-auto"
              >
                {t.hero.signIn}
              </Link>
            </>
      ...
      >
        {[
          ...
          <div key={i} className="group rounded-2xl border border-gray-800 bg-gray-900/40 p-6 text-left transition-all hover:border-gray-700 hover:bg-gray-900/60">
            <div className="mb-4 rounded-xl bg-gray-800/50 p-3 w-fit group-hover:bg-gray-800">{feature.icon}</div>

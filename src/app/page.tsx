...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center overflow-hidden px-4 py-24 text-center">
      ...
      <div className="relative z-10 mt-24 grid w-full max-w-5xl grid-cols-1 gap-8 sm:grid-cols-3">
        {[
          ...
          <motion.div
            ...
            className="group rounded-2xl border border-gray-200 dark:border-gray-800 bg-white/40 dark:bg-gray-900/40 p-6 text-left transition-all hover:border-blue-400 dark:hover:border-gray-700 hover:bg-white dark:hover:bg-gray-900/60 shadow-sm hover:shadow-xl"
          >
